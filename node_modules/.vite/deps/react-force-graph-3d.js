...
var require_fromentries = __commonJS({
  "node_modules/.pnpm/fromentries@1.3.2/node_modules/fromentries/index.js"(exports, module) {
    module.exports = function fromEntries2(iterable) {
...
var require_getVariableName = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/getVariableName.js"(exports, module) {
...
var require_createPatternBuilder = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/createPatternBuilder.js"(exports, module) {
...
var require_generateCreateBody = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/generateCreateBody.js"(exports, module) {
...
var require_generateQuadTree = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/generateQuadTree.js"(exports, module) {
    var createPatternBuilder = require_createPatternBuilder();
    var getVariableName = require_getVariableName();
...
var require_generateBounds = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/generateBounds.js"(exports, module) {
...
var require_generateCreateDragForce = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/generateCreateDragForce.js"(exports, module) {
    var createPatternBuilder = require_createPatternBuilder();
...
var require_generateCreateSpringForce = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/generateCreateSpringForce.js"(exports, module) {
    var createPatternBuilder = require_createPatternBuilder();
...
var require_generateIntegrator = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/codeGenerators/generateIntegrator.js"(exports, module) {
    var createPatternBuilder = require_createPatternBuilder();
...
var require_spring = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/spring.js"(exports, module) {
...
var require_ngraph3 = __commonJS({
  "node_modules/.pnpm/ngraph.merge@1.0.0/node_modules/ngraph.merge/index.js"(exports, module) {
...
var require_ngraph4 = __commonJS({
  "node_modules/.pnpm/ngraph.random@1.1.0/node_modules/ngraph.random/index.js"(exports, module) {
...
var require_createPhysicsSimulator = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/lib/createPhysicsSimulator.js"(exports, module) {
...
var require_ngraph5 = __commonJS({
  "node_modules/.pnpm/ngraph.forcelayout@3.3.1/node_modules/ngraph.forcelayout/index.js"(exports, module) {
...
// node_modules/.pnpm/react-kapsule@2.4.0_react@18.3.1/node_modules/react-kapsule/dist/react-kapsule.mjs
...
// node_modules/.pnpm/three@0.160.1/node_modules/three/examples/jsm/controls/DragControls.js
...
function link_default(links) {
  var id = index2, strength = defaultStrength, strengths, distance = constant_default(30), distances, nodes, nDim, count2, bias, random, iterations = 1;
  if (links == null) links = [];
...
// node_modules/.pnpm/three-forcegraph@1.41.14_three@0.160.1/node_modules/three-forcegraph/dist/three-forcegraph.mjs
...
// node_modules/.pnpm/accessor-fn@1.5.1/node_modules/accessor-fn/dist/accessor-fn.mjs
    ...
    (function flatten(node) {
      ...
      if (accKeys.length === keys.length) {
        ...
        Object.entries(node).forEach(function(_ref2) {
          ...
          return flatten(val, [].concat(_toConsumableArray3(accKeys), [key]));
        });
      }
    })(indexedResult);
...
function diffArrays(prev, next, idAccessor) {
  ...
  if (!idAccessor) {
    ...
    new Set([].concat(_toConsumableArray4(prevSet), _toConsumableArray4(nextSet))).forEach(function(item) {
      var type = !prevSet.has(item) ? "enter" : !nextSet.has(item) ? "exit" : "update";
      result[type].push(type === "update" ? [item, item] : item);
    });
  } else {
    var prevById = index6(prev, idAccessor, false);
    var nextById = index6(next, idAccessor, false);
    var byId = Object.assign({}, prevById, nextById);
    Object.entries(byId).forEach(function(_ref) {
      var _ref2 = _slicedToArray5(_ref, 2), id = _ref2[0], item = _ref2[1];
...
function dataBindDiff(data, existingObjs, _ref3) {
  ...
  diff.update = diff.update.map(function(_ref4) {
    var _ref5 = _slicedToArray5(_ref4, 2), prevD2 = _ref5[0], nextD2 = _ref5[1];
    if (prevD2 !== nextD2) {
  ...
  diff.exit = diff.exit.concat(removeObjs.map(function(obj) {
    return _defineProperty2({}, objBindAttr, obj);
  }));
  return diff;
}
function viewDigest(data, existingObjs, appendObj, removeObj, _ref7) {
  ...
  var pointsData = [].concat(_toConsumableArray4(enter), _toConsumableArray4(update4));
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i = -1, j = 0, n = specifier.length, c4, pad3, format3;
...
function getDagDepths(_ref, idAccessor) {
  ...
  var nodeDepths = Object.assign.apply(Object, [{}].concat(_toConsumableArray5(Object.entries(graph2).filter(function(_ref4) {
  ...
  methods: {
    ...
    tickFrame: function tickFrame(state) {
      ...
      function updateArrows() {
        ...
        state.graphData.links.forEach(function(link) {
          ...
          var headVec = _construct(three$1.Vector3, _toConsumableArray5(["x", "y", "z"].map(function(c4) {
            return arrowHead[c4];
          })));
      ...
      function updatePhotons() {
        ...
        state.graphData.links.forEach(function(link) {
          ...
          var photons = [].concat(_toConsumableArray5(cyclePhotons || []), _toConsumableArray5(singleHopPhotons || []));
    ...
    getGraphBbox: function getGraphBbox(state) {
      ...
      var bboxes = function getBboxes(obj) {
        ...
        return bboxes2.concat.apply(bboxes2, _toConsumableArray5((obj.children || []).filter(
          function(obj2) {
      ...
      return Object.assign.apply(Object, _toConsumableArray5(["x", "y", "z"].map(function(c4) {
        return _defineProperty3({}, c4, [min(bboxes, function(bb) {
          return bb.min[c4];
      ...
      threeDigest(state.graphData.nodes.filter(visibilityAccessor), state.graphScene, {
        ...
        updateObj: function updateObj(obj, node) {
          if (obj.__graphDefaultObj) {
            ...
            var color2 = colorAccessor(node);
            var materialColor = new three$1.Color(colorStr2Hex(color2 || "#ffffaa"));
            var opacity = state.nodeOpacity * colorAlpha(color2);
            if (obj.material.type !== "MeshLambertMaterial" || !obj.material.color.equals(materialColor) || obj.material.opacity !== opacity) {
              if (!sphereMaterials.hasOwnProperty(color2)) {
              ...
              obj.material = sphereMaterials[color2];
            }
          }
        }
      });
        ...
        updateObj: function updateObj(updObj, link) {
          if (updObj.__graphDefaultObj) {
            ...
            if (customMaterial) {
              ...
              var materialColor = new three$1.Color(colorStr2Hex(color2 || "#f0f0f0"));
              ...
              if (obj.material.type !== materialType || !obj.material.color.equals(materialColor) || obj.material.opacity !== opacity) {
                ...
                if (!lineMaterials.hasOwnProperty(color2)) {
                ...
                obj.material.dispose();
                obj.material = lineMaterials[color2];
              }
            }
          }
        }
      ...
      if (state.linkDirectionalParticles || changedProps.hasOwnProperty("linkDirectionalParticles")) {
        ...
        threeDigest(visibleLinks.filter(particlesAccessor), state.graphScene, {
          ...
          updateObj: function updateObj(obj, link) {
            ...
            threeDigest(_toConsumableArray5(new Array(numPhotons)).map(function(_, idx) {
              return {
                idx
              };
            }), obj, {
...
function fromKapsule(kapsule) {
  ...
  var FromKapsule = function(_baseClass) {
    ...
    function FromKapsule2() {
      ...
      _this.__kapsuleInstance = kapsule().apply(void 0, [].concat(_toConsumableArray5(initKapsuleWithSelf ? [_assertThisInitialized2(_this)] : []), args));
      return _this;
    }
...
// node_modules/.pnpm/three@0.160.1/node_modules/three/examples/jsm/controls/TrackballControls.js
...
// node_modules/.pnpm/three@0.160.1/node_modules/three/examples/jsm/controls/FlyControls.js
...
// node_modules/.pnpm/three-render-objects@1.29.5_three@0.160.1/node_modules/three-render-objects/dist/three-render-objects.mjs
...
var threeRenderObjects = index3({
  ...
  methods: {
      ...
      if (state.initialised) {
        ...
        if (state.enablePointerInteraction) {
          ...
          if (topObject !== state.hoverObj) {
            ...
            state.toolTipElem.innerHTML = topObject ? index4(state.tooltipContent)(topObject) || "" : "";
    ...
    fitToBbox: function fitToBbox(state, bbox) {
      ...
      if (bbox) {
        ...
        var maxBoxSide = Math.max.apply(Math, _toConsumableArray6(Object.entries(bbox).map(function(_ref) {
          var _ref2 = _slicedToArray7(_ref, 2), coordType = _ref2[0], coords = _ref2[1];
          return Math.max.apply(Math, _toConsumableArray6(coords.map(function(c4) {
    ...
    getBbox: function getBbox(state) {
      ...
      return Object.assign.apply(Object, _toConsumableArray6(["x", "y", "z"].map(function(c4) {
        return _defineProperty4({}, c4, [box.min[c4], box.max[c4]]);
      })));
    },
  ...
  init: function init2(domNode, state) {
    ...
    [state.renderer, state.postProcessingComposer].concat(_toConsumableArray6(state.extraRenderers)).forEach(function(r) {
...
// node_modules/.pnpm/3d-force-graph@1.73.4/node_modules/3d-force-graph/dist/3d-force-graph.mjs
...
var linkedFGProps = Object.assign.apply(Object, _toConsumableArray7(["jsonUrl", "graphData", "numDimensions", "dagMode", "dagLevelDistance", "dagNodeFilter", "onDagError", "nodeRelSize", "nodeId", "nodeVal", "nodeResolution", "nodeColor", "nodeAutoColorBy", "nodeOpacity", "nodeVisibility", "nodeThreeObject", "nodeThreeObjectExtend", "linkSource", "linkTarget", "linkVisibility", "linkColor", "linkAutoColorBy", "linkOpacity", "linkWidth", "linkResolution", "linkCurvature", "linkCurveRotation", "linkMaterial", "linkThreeObject", "linkThreeObjectExtend", "linkPositionUpdate", "linkDirectionalArrowLength", "linkDirectionalArrowColor", "linkDirectionalArrowRelPos", "linkDirectionalArrowResolution", "linkDirectionalParticles", "linkDirectionalParticleSpeed", "linkDirectionalParticleWidth", "linkDirectionalParticleColor", "linkDirectionalParticleResolution", "forceEngine", "d3AlphaDecay", "d3VelocityDecay", "d3AlphaMin", "ngraphPhysics", "warmupTicks", "cooldownTicks", "cooldownTime", "onEngineTick", "onEngineStop"].map(function(p) {
  return _defineProperty5({}, p, bindFG.linkProp(p));
})));
var linkedFGMethods = Object.assign.apply(Object, _toConsumableArray7(["refresh", "getGraphBbox", "d3Force", "d3ReheatSimulation", "emitParticle"].map(function(p) {
  return _defineProperty5({}, p, bindFG.linkMethod(p));
})));
var bindRenderObjs = linkKapsule("renderObjs", threeRenderObjects);
var linkedRenderObjsProps = Object.assign.apply(Object, _toConsumableArray7(["width", "height", "backgroundColor", "showNavInfo", "enablePointerInteraction"].map(function(p) {
  return _defineProperty5({}, p, bindRenderObjs.linkProp(p));
})));
var linkedRenderObjsMethods = Object.assign.apply(Object, _toConsumableArray7(["lights", "cameraPosition", "postProcessingComposer"].map(function(p) {
  return _defineProperty5({}, p, bindRenderObjs.linkMethod(p));
})).concat([{
...
// node_modules/.pnpm/react-force-graph-3d@1.24.4_react@18.3.1/node_modules/react-force-graph-3d/dist/react-force-graph-3d.mjs
