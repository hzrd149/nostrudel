...
const json5Language = /*@__PURE__*/LRLanguage.define({
...
const json5ParseCache = /*@__PURE__*/StateField.define({
    create() {
        return null;
    },
    update(oldValue, tx) {
...
const jsonCursorPath = /*@__PURE__*/StateField.define({
    create() {
...
export { json5, json5Language, json5ParseCache, json5ParseLinter, jsonCursorPath };
