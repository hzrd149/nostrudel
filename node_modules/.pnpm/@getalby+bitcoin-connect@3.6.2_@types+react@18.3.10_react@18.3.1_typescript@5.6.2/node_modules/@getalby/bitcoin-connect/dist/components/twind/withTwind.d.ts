...
}>(BaseElement: T) => (new (...args: any[]) => {
    readonly tw: import("@twind/core").Twind<any, CSSStyleSheet>;
    connectedCallback(): void;
    disconnectedCallback(): void;
    accessKey: string;
...
export declare const withTwind: () => typeof withNothing;
declare function withNothing<T extends new (...args: any[]) => LitElement>(Base: T): T;
export {};
