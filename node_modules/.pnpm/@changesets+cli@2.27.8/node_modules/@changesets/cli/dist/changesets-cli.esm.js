...
function publish$1(pkgName, opts, twoFactorState) {
      ...
      case "version":
        {
          ...
          const packagesByName = new Map(packages.packages.map(x => [x.packageJson.name, x])); // validate that all dependents of skipped packages are also skipped
