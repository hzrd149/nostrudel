...
export interface AssetWallet {
     ...
     */
    fundVirtualPsbt(request?: DeepPartial<FundVirtualPsbtRequest>): Promise<FundVirtualPsbtResponse>;
    /**
     * SignVirtualPsbt signs the inputs of a virtual transaction and prepares the
     * commitments of the inputs and outputs.
     */
    signVirtualPsbt(request?: DeepPartial<SignVirtualPsbtRequest>): Promise<SignVirtualPsbtResponse>;
    /**
     ...
     * transactions.
     */
    anchorVirtualPsbts(request?: DeepPartial<AnchorVirtualPsbtsRequest>): Promise<SendAssetResponse>;
    /**
     ...
     */
    nextInternalKey(request?: DeepPartial<NextInternalKeyRequest>): Promise<NextInternalKeyResponse>;
    /**
     ...
     */
    nextScriptKey(request?: DeepPartial<NextScriptKeyRequest>): Promise<NextScriptKeyResponse>;
    /**
     ...
     */
    proveAssetOwnership(request?: DeepPartial<ProveAssetOwnershipRequest>): Promise<ProveAssetOwnershipResponse>;
    /**
     ...
     * UTXO.
     */
    removeUTXOLease(request?: DeepPartial<RemoveUTXOLeaseRequest>): Promise<RemoveUTXOLeaseResponse>;
}
...
export {};
//# sourceMappingURL=assetwallet.d.ts.map