 ...
 */
export declare enum ProofTransferType {
    /**
...
export interface TaprootAssets {
     ...
     */
    subscribeReceiveAssetEventNtfns(request?: DeepPartial<SubscribeReceiveAssetEventNtfnsRequest>, onMessage?: (msg: ReceiveAssetEvent) => void, onError?: (err: Error) => void): void;
    /**
     * tapcli: `assets meta`
