...
var use_mouse_down_ref_exports = {};
__export(use_mouse_down_ref_exports, {
  useMouseDownRef: () => useMouseDownRef
});
module.exports = __toCommonJS(use_mouse_down_ref_exports);
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react4.useRef)();
