...
- [x] 03-04-PLAN.md — D-09 `useAsyncAction` conversion for 3 user-triggered actions (wave 2)
- [x] 03-05-PLAN.md — D-13/D-14/D-15 strays: sqlite ceremony, async promise executor, cache-key ignore, index.tsx logger (wave 2)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-06-PLAN.md — AGENTS.md error-handling convention (D-03) and the 31 → 0 rescan report (D-04) (wave 3)
...
- [x] 04-10-PLAN.md — residual unused imports and the 4 cross-group duplicate merges (wave 4)
...
- [x] 04-12-PLAN.md — create the draft on the PoW path in both composers; match the success check to the worker's break condition (wave 6)
