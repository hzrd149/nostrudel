...
updated: 2026-09-15T15:42:57Z
---

## Current Test

number: 1
name: useAsyncAction loading state and failure toast on the three converted controls (D-09)
expected: |
  Each of Remove Mint, Remove Relay and Clear Database shows the same spinner/disabled
  behavior as before the conversion, and a failure now raises a toast where previously
